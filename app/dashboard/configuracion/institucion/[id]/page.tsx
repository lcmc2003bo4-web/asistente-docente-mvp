    ...
    useEffect(() => {
        async function load() {
            ...
            if (inst) {
                ...
                setTipoGestion(((inst as any).tipo_gestion as TipoGestion) || 'Pública')
    ...
    return (
        <div className="max-w-3xl mx-auto py-8 px-4">
            ...
            <div className="mb-8">
                ...
                <h1 className="text-2xl font-bold text-gray-900">Perfil de Contextualización IA</h1>
                <p className="text-gray-500 mt-1 text-sm">
                    Esta información alimenta directamente el prompt de la IA para que las Unidades de Aprendizaje reflejen la realidad de tu comunidad educativa.
                </p>
            </div>
