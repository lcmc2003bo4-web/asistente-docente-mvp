...
-- CYT-C3-CAP5: Genera y registra datos e información
INSERT INTO desempenos (capacidad_id, grado_id, codigo, descripcion) VALUES
((SELECT id FROM capacidades WHERE codigo = 'CYT-C3-CAP5'), (SELECT id FROM grados WHERE nombre = '4° Secundaria'), 'CYT-C3-CAP5-D4', 'Genera y registra datos e información usando instrumentos y técnicas apropiadas, organizándolos en tablas, gráficos y representaciones, y considerando el margen de error y la confiabilidad de las mediciones.'),
((SELECT id FROM capacidades WHERE codigo = 'CYT-C3-CAP5'), (SELECT id FROM grados WHERE nombre = '5° Secundaria'), 'CYT-C3-CAP5-D5', 'Genera y registra datos e información usando instrumentos y técnicas avanzadas, organizándolos en representaciones sofisticadas, aplicando análisis estadístico y considerando el margen de error, la confiabilidad y la validez de las mediciones.');
